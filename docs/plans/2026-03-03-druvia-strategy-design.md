...
| M2: 快速建表模板 | ✅ 已完成 | 5 种模板 |
| M3: SQL 编辑器增强 | ⏳ Phase 2 继续 | 多标签、语法高亮（已有计划，继续完成） |
| **M17: Authentication 管理界面** | 🆕 新增 | OAuth 配置、用户管理 |
| **M18: Storage 管理界面** | 🆕 新增 | Buckets、文件管理 |
| **M19: Edge Functions** | 🆕 新增 | Deno Worker + 管理 UI |
| **M20: Realtime 管理界面** | 🆕 新增 | Hasura Subscriptions 可视化 |
| **M7: ER 图可视化** | 🆕 提前 | reactflow |
...
| 顺序 | 模块 | 理由 |
|------|------|------|
| 1 | M18: Storage 管理界面 | 后端已有，仅需 UI |
| 2 | M17: Authentication 管理界面 | 后端部分存在，扩展即可 |
| 3 | M20: Realtime 管理界面 | 基于 Hasura，封装即可 |
| 4 | M3: SQL 编辑器 | 独立功能，随时可做 |
| 5 | M19: Edge Functions | 最复杂，需要新增 Deno 容器 |
| 6 | M7: ER 图 | 独立功能，最后完善 |
