...
- 在生产同构预发布环境核对并演练 migration `018 -> 026`、数据库/Storage 备份、服务健康检查、项目成员授权、Data Access baseline/recovery、表删除 outbox、账户删除/设备擦除围栏、镜像回滚和必要的数据库人工恢复
